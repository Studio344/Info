...
#### UI-02: ハンバーガーメニューのフォーカストラップ & Escape キー対応
...
#### SEC-01: DOMPurify フォールバックの XSS リスク
...
#### SEC-04: Content-Security-Policy (CSP) の導入
...
#### DEV-01: GitHub Actions CI パイプライン
